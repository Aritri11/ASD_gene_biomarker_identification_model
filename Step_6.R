...
write_csv(limma_results, "C:/Users/Aritri Baidya/Desktop/ML Project/R_codes/DEG_results_with_limma.csv")
...
p <- ggplot(volcano_data, aes(x = Log2FC, y = -log10(adj_pval), color = significant)) +
  geom_point(alpha = 0.6) +
  geom_hline(yintercept = -log10(0.05), color = "red", linetype = "dashed") +
  geom_vline(xintercept = c(-1, 1), color = "blue", linetype = "dashed", alpha = 0.5) +
...
ggsave("C:/Users/Aritri Baidya/Desktop/ML Project/R_codes/volcano_plot_limma.png", plot = p, width = 8, height = 6)
